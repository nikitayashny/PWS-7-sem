...
namespace SyndicationServiceLibrary
{
    public class Feed : IFeed
    {
        ...
        public object GetStudentNotes(string studentId)
        {
            ...
            List<SyndicationItem> items = new List<SyndicationItem>();
            StudentsEntities notes = new StudentsEntities(new Uri("http://localhost:51565/Service1.svc/"));
            ...
            {
                HttpWebRequest request = (HttpWebRequest)HttpWebRequest.Create("http://localhost:51565/Service1.svc/note?$format=json");
                request.Method = "GET";
